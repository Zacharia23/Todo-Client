        ...
        <div className='antialiased flex flex-col overflow-hidden'>
            ...
            <div className='sticky mt-10 border-t border-gray-200'>
               <div className='flex items-center justify-end mt-3'>
                   <button className='inline-flex items-center rounded-sm border border-transparent bg-slate-600 px-12 py-3 text-base font-medium leading-4 text-white hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2'>
                       Submit Task
                   </button>
               </div>
            </div>
